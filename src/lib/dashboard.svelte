<script lang="ts">
  ...
  let activeDetailTab: 'headers' | 'payload' | 'response' = 'response';
                  ...
                  <div class="log-details" on:click|stopPropagation>
                    <div class="detail-tabs">
                      <button
                        ...
                        on:click|stopPropagation={() => activeDetailTab = 'headers'}
                      >
                        Headers
                      </button>
                      <button
                        ...
                        on:click|stopPropagation={() => activeDetailTab = 'payload'}
                      >
                        Payload
                      </button>
                      <button
                        ...
                        on:click|stopPropagation={() => activeDetailTab = 'response'}
                      >
                        Response
                      </button>
                    </div>
